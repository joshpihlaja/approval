...
export class FormService {
    ...
    public getForm(formResponseID) {
        return this._GetJson("admin/controller.cfm?method=formservice.getJobFormHTMLByFormResponseID&formResponseID=17257&API_KEY=03DAC006-B069-E311-B7A4-0017A4770044");
    }
